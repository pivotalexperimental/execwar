...
Warbler::Config.new do |config|
  ...
  config.java_libs += FileList[
    "lib/java/jruby-complete-1.4.0RC1.jar",
    "lib/java/jetty/*.jar"
	]
  ...
  # Populate config.gems from geminstaller config file
  # require 'geminstaller'
  geminstaller_registry = GemInstaller.create_registry
  geminstaller_config_builder = geminstaller_registry.config_builder
  geminstaller_config = geminstaller_config_builder.build_config
  geminstaller_gems = geminstaller_config.gems
  geminstaller_gems.each do |geminstaller_gem|
    config.gems[geminstaller_gem.name] = geminstaller_gem.version
  end
  ...
  # config.public_html = FileList["public/**/*", "doc/**/*"]
   config.public_html = FileList["public/*.*",
			 													 "public/flash/**/*",
			 													 "public/javascripts/third-party/**/*.gif",
																 "public/javascripts/third-party/**/*.png",
																 "public/images/**/*"]
  ...
  # config.webxml.jruby.min.runtimes = 2
   ...
   config.webxml.jruby.runtimes = 1
